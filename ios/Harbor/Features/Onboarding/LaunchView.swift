...
/// Splash shown while Harbor restores the signed-in session.
...
struct FirebaseSetupRequiredView: View {
    var body: some View {
        ContentUnavailableView {
            ...
            Text("Add GoogleService-Info.plist to Harbor/Resources and rebuild the app.")
        } actions: {
