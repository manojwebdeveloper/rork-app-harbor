            ...
            VStack(spacing: 14) {
                ...
                Button {
                    ...
                    Text("Continue as guest")
                        ...
                        .frame(height: 54)
                        .background(HarborColors.seaGlass)
                ...
                Text("Guest mode creates a private temporary account — perfect for previewing. Apple may share your name and email only the first time you sign in with Apple.")
                    .font(.footnote)
                    .foregroundStyle(.secondary)
                    .multilineTextAlignment(.center)
            }
