...
/// Placeholder — layout only. Explains why HarborFamilyLocation asks for location before the system prompt.
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 22) {
            ...
            VStack(alignment: .leading, spacing: 8) {
                ...
                Text("HarborFamilyLocation only works when you choose to share. Here is what that means:")
                    .font(.subheadline)
