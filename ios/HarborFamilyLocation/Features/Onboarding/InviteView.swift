            ...
            VStack(spacing: 22) {
                if let invitation {
                    VStack(spacing: 4) {
                        ...
                        Text("Invite your family. Everyone installs HarborFamilyLocation and chooses to share.")
                            .font(.subheadline)
                    ...
                    VStack(spacing: 7) {
                        Text("INVITATION CODE")
                            ...
                            .foregroundStyle(.secondary)
                        Text(invitation.code)
                            .font(HarborFamilyLocationTypography.monoCode)
                            .tracking(5)
                    ...
                    ShareLink(
                        ...
                        subject: Text("Join \(invitation.circleName) in HarborFamilyLocation"),
                        message: Text("Open this link in HarborFamilyLocation, scan the QR code, or enter code \(invitation.code).")
                    ) {
