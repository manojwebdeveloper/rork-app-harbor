    ...
    private var notificationCard: some View {
        HStack(alignment: .top, spacing: 11) {
            ...
            VStack(alignment: .leading, spacing: 2) {
                ...
                Text("Your week with \(HarborFamilyLocationSample.digestCircleName)")
                    .font(.system(size: 15, weight: .bold))

                Text("\(HarborFamilyLocationSample.digestCheckIns) check-ins, \(HarborFamilyLocationSample.digestPlaces) places visited, no missed alerts. Tap to read the summary.")
                    .font(.system(size: 14))
