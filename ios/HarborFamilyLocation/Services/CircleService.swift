...
// API does not declare Sendable conformance. HarborFamilyLocation only places immutable String and
...
enum CircleServiceError: LocalizedError {
    ...
    var errorDescription: String? {
        ...
        case .invalidServerResponse:
            "HarborFamilyLocation received an invalid response. Please try again."
        }
    }
}
